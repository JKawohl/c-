========================================================================
    KONSOLENANWENDUNG: Flaschenautomazt.v.6.0-Projektübersicht
========================================================================

Diese Flaschenautomazt.v.6.0-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Flaschenautomazt.v.6.0-Anwendung besteht.


Flaschenautomazt.v.6.0.vcxproj
...
Flaschenautomazt.v.6.0.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Flaschenautomazt.v.6.0.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
