========================================================================
    KONSOLENANWENDUNG: Getraenkeautomat.v.7.0-Projektübersicht
========================================================================

Diese Getraenkeautomat.v.7.0-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Getraenkeautomat.v.7.0-Anwendung besteht.


Getraenkeautomat.v.7.0.vcxproj
...
Getraenkeautomat.v.7.0.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Getraenkeautomat.v.7.0.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
