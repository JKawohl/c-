========================================================================
    KONSOLENANWENDUNG: Pointersfirststeps-Projektübersicht
========================================================================

Diese Pointersfirststeps-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Pointersfirststeps-Anwendung besteht.


Pointersfirststeps.vcxproj
...
Pointersfirststeps.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Pointersfirststeps.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
