========================================================================
    KONSOLENANWENDUNG: functionsplayground-Projektübersicht
========================================================================

Diese functionsplayground-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre functionsplayground-Anwendung besteht.


functionsplayground.vcxproj
...
functionsplayground.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen functionsplayground.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
